            ...
            <div className="mx-auto w-full max-w-275 px-8">
                ...
                <div className="max-w-175">
                    ...
                    <h1 className="mb-6 text-[4rem] font-extrabold leading-[1.1] tracking-tighter sm:text-5xl md:text-7xl">
                        Construindo experiências digitais <span className="bg-linear-to-r from-white to-blue-500 bg-clip-text text-transparent">incríveis</span>.
                    </h1>

                    {/* Parágrafo */}
                    <p className="mb-10 max-w-125 text-lg text-neutral-400">
                        Sou Felipe Giacomini, um desenvolvedor Full Stack focado em criar soluções escaláveis, combinando
                        performance técnica e design intuitivo.
                    </p>
